 ...
 * over the SSE stream.
 *
 * @property phase          One of: "acknowledge", "bridge", "synthesis", "apology", "first-response".
 ...
 * @property renderStrategy Voice Rendering Policy hint: "live" | "cached" | "skip" | "stop".
 ...
 * @property moveType       First-response posture move type (e.g. RECEIPT, COMMIT, WAIT, YIELD).
 *                          Null for non-first-response phases.
